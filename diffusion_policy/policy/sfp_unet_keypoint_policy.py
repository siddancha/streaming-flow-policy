...
class SFPUnetKeypointPolicy(BaseImagePolicy):
    def __init__(self, 
        ...
        del obs_encoder.obs_nets['image']
        del obs_encoder.obs_randomizers['image']
        del obs_encoder.obs_share_mods['image']
    ...
    def get_traj(self,
            ...
            B = nobs['agent_pos'].shape[0] # batch size
            if not self.use_action_traj:
                pass
                ### not used here
                prev_x = nobs['agent_pos'][:,-1:,:] # agent position nobs (56, 2, 2) -> x_test (56, 1, 2)
    ...
    def set_normalizer(self, normalizer: LinearNormalizer):
        ...
        print('action normalizer', normalizer['action'].state_dict())
